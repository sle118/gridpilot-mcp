...
- keep the audit strict enough to reject schema leaf nodes that only carry `description`; Copilot manifest compatibility appears to need concrete schema keywords on leaf nodes as well.
